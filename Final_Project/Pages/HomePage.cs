...
namespace Final_Project.Pages
{
    internal class HomePage : BasePage
    {
        ...
        public static IWebElement AddHomePageProductToCartAndVerifyDetails(int index)
        {
            ...
            priceProduct = ShoppingCartShoppingPage.ProductPrice.GetText();
            productQuantity = ShoppingCartShoppingPage.ProductQuantity.GetText();
            productAttributes = ShoppingCartShoppingPage.ProductAttributes.GetText();
