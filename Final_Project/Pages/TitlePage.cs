...
{
    internal class TitlePage : BasePage
    {
        ...
        public static Element EUR => new Element(By.XPath("//*[@id='setCurrency']/ul/li[3]/a"));
        public static Element USD => new Element(By.XPath("//*[@id='setCurrency']/ul/li[2]/a"));
        public static Element UAH => new Element(By.XPath("//*[@id='setCurrency']/ul/li/a"));
        ...
        public static void VerifySubMenu(Element SubMenuTriggerButton, Element SubMenuPanel)
        {
